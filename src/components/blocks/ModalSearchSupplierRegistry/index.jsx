...
const ModalSearchSupplierRegistry = () => {
  return (
    <div>
      <FormGroup className='mb-4'>
        <Label>Búsqueda por nombre de Proveedor</Label>
          ...
          <Table.Body>
            {DataCategoria.map((element) => (
              <Table.Row key={element.codigo}>
                ...
                <Table.Col>{element.nombreCategoría}</Table.Col>
                <Table.Col as='th' >
...
export default ModalSearchSupplierRegistry;
